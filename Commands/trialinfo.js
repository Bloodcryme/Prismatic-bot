module.exports= {
    ...
    execute(message, args){
        ...
        '• Any tactic videos, WAs or anything else that might be relevant to a specific fight during progression will be either shared ahead of time in <#819596858078003238>, <#853792088867864637> or in-game during the raid itself in the case of something minor that doesn\'t require previous preparation. We also have a small list of mandatory addons that all raiders must have:\n')
